        ...
        <div className="bg-white rounded-lg shadow-sm p-8 space-y-6">
          ...
          <div>
            ...
            <ul className="list-disc list-inside text-gray-600 space-y-2 ml-4 mb-6">
              ...
              <li><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Angela Mendez, LPC, 840 Kennesaw Ave NW Ste 8, Marietta, GA 30060.</li>
              ...
              <li><strong>Website</strong> refers to amend-therapy, accessible from www.amend-therapy.com</li>
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">Tracking Technologies and Cookies</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">We use both Session and Persistent Cookies for the purposes set out below:</p>
            
            <h4 className="text-lg font-semibold text-gray-800 mb-2">Necessary / Essential Cookies</h4>
            <p className="text-gray-600 leading-relaxed mb-2"><strong>Type:</strong> Session Cookies</p>
            <p className="text-gray-600 leading-relaxed mb-2"><strong>Administered by:</strong> Us</p>
            ...
            <p className="text-gray-600 leading-relaxed mb-2"><strong>Type:</strong> Persistent Cookies</p>
            <p className="text-gray-600 leading-relaxed mb-2"><strong>Administered by:</strong> Us</p>
            <p className="text-gray-600 leading-relaxed mb-4"><strong>Purpose:</strong> These Cookies identify if users have accepted the use of cookies on the Website.</p>

            <h4 className="text-lg font-semibold text-gray-800 mb-2">Functionality Cookies</h4>
            <p className="text-gray-600 leading-relaxed mb-2"><strong>Type:</strong> Persistent Cookies</p>
            <p className="text-gray-600 leading-relaxed mb-2"><strong>Administered by:</strong> Us</p>
            <p className="text-gray-600 leading-relaxed mb-6"><strong>Purpose:</strong> These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</p>
          ...
          <div>
            ...
            <div className="mt-4 p-4 bg-gray-50 rounded-lg">
              <p className="text-gray-700">
                By email: <a href="mailto:angela@amendlpc.com" className="text-blue-600 hover:text-blue-800">angela@amendlpc.com</a>
              </p>
            </div>
          </div>
        </div>
