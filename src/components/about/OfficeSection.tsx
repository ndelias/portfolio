      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="w-full h-96 bg-gradient-to-br from-blue-200 to-blue-100 rounded-2xl overflow-hidden">
              ...
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  ...
                  <span className="text-blue-700 text-lg">Office Space</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl">
              ...
              <p className="text-gray-600">123 Therapy Street, Suite 100<br />
              Your City, MS 12345</p>
            </div>
          </div>
        </div>
      </div>
